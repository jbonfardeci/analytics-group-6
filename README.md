Summer 2017 TAMU Analytics - Group 6, aka "Accrual Bromance Bacon World" (it made Cameron happy)
...
```
git clone https://github.com/jbonfardeci/analytics-group-6.git
cd analytics-group-6
```
